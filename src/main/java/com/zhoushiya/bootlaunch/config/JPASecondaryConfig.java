package com.zhoushiya.bootlaunch.config;
...
@EnableJpaRepositories(basePackages = "com.zhoushiya.bootlaunch.jpa.testdb2",   //注意这里
...
public class JPASecondaryConfig {
    ...
    public LocalContainerEntityManagerFactoryBean masterEntityManager() throws Throwable {
        ...
        //这里要修改成主数据源的扫描包
        entityManager.setPackagesToScan("com.zhoushiya.bootlaunch.jpa.testdb2");
